...
public interface MCCMerchantContainer extends MCCContainer<MCCEntityContainerSource<MCCEntity>> {

    MCCContainer<MCCEntityContainerSource<MCCEntity>> getContainerOfMerchant();
