...
public class NMSCartographyTableContainer extends NMSContainer<MCCBlockContainerSource, CartographyTableMenu> implements MCCCartographyTableContainer {
    public static final MCCConverter<CartographyTableMenu, NMSCartographyTableContainer> CONVERTER = converter(NMSCartographyTableContainer.class, CartographyTableMenu.class, NMSCartographyTableContainer::new, NMSHandle::getHandle);
