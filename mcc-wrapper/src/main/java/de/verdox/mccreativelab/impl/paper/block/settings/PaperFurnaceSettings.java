...
public class PaperFurnaceSettings implements MCCFurnaceSettings, Listener {
    ...
    public void initVanillaBurnDurations() {
        ...
        addFurnaceFuel(MCCItemTags.LOGS.get(), 300);
        addFurnaceFuel(MCCItemTags.BAMBOO_BLOCKS.get(), 300);
        addFurnaceFuel(MCCItemTags.VILLAGER_PLANTABLE_SEEDS.get(), 300);
        addFurnaceFuel(MCCItemTags.PLANKS.get(), 300);
        addFurnaceFuel(MCCItems.BAMBOO_MOSAIC.get(), 300);
        addFurnaceFuel(MCCItemTags.WOODEN_STAIRS.get(), 300);
        addFurnaceFuel(MCCItems.BAMBOO_MOSAIC_STAIRS.get(), 300);
        addFurnaceFuel(MCCItemTags.WOODEN_SLABS.get(), 150);
        addFurnaceFuel(MCCItems.BAMBOO_MOSAIC_SLAB.get(), 150);
        addFurnaceFuel(MCCItemTags.WOODEN_TRAPDOORS.get(), 300);
        addFurnaceFuel(MCCItemTags.WOODEN_PRESSURE_PLATES.get(), 300);
        addFurnaceFuel(MCCItemTags.WOODEN_FENCES.get(), 300);
        addFurnaceFuel(MCCItemTags.FENCE_GATES.get(), 300);
        ...
        addFurnaceFuel(MCCItemTags.BANNERS.get(), 300);
        addFurnaceFuel(MCCItems.BOW.get(), 300);
        addFurnaceFuel(MCCItems.FISHING_ROD.get(), 300);
        addFurnaceFuel(MCCItems.LADDER.get(), 300);
        addFurnaceFuel(MCCItemTags.SIGNS.get(), 200);
        addFurnaceFuel(MCCItemTags.HANGING_SIGNS.get(), 800);
        ...
        addFurnaceFuel(MCCItemTags.WOODEN_DOORS.get(), 200);
        addFurnaceFuel(MCCItemTags.BOATS.get(), 1200);
        addFurnaceFuel(MCCItemTags.CHEST_BOATS.get(), 1200);
        addFurnaceFuel(MCCItemTags.WOOL.get(), 100);
        addFurnaceFuel(MCCItemTags.WOODEN_BUTTONS.get(), 100);
        addFurnaceFuel(MCCItems.STICK.get(), 100);
        addFurnaceFuel(MCCItemTags.SAPLINGS.get(), 100);
        addFurnaceFuel(MCCItems.BOWL.get(), 100);
        addFurnaceFuel(MCCItemTags.WOOL_CARPETS.get(), 67);
