...
public enum Resolution {
    FULL_HD(1920, 1080, new AssetBasedResourcePackResource(Key.key("mccreativelab", "item/menu/fullhd"), new Asset<>("/resolution/fullhdmenu.json"), ResourcePackAssetTypes.MODELS, "json")),
    HD(1280, 720, new AssetBasedResourcePackResource(Key.key("mccreativelab", "item/menu/hdmenu"), new Asset<>("/resolution/hdmenu.json"), ResourcePackAssetTypes.MODELS, "json")),
    ;
    ...
    public static ItemTextureData.ModelType createModel(Resolution resolution, Key textureKey) {
