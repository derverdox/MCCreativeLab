...
public class StandardFontAssets {
    ...
    public static final AssetBasedResourcePackResource ascii = new AssetBasedResourcePackResource(Key.key("mccreativelab","hud/standard_ascii"), new Asset<>(() -> StandardFontAssets.class.getResourceAsStream("/resourcepack/font/ascii.png")), ResourcePackAssetTypes.TEXTURES, "png");
    public static final AssetBasedResourcePackResource accented = new AssetBasedResourcePackResource(Key.key("mccreativelab","hud/standard_accented"), new Asset<>(() -> StandardFontAssets.class.getResourceAsStream("/resourcepack/font/accented.png")), ResourcePackAssetTypes.TEXTURES, "png");
