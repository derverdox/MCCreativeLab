...
public class AssetUtil {
    public static<C extends CustomPack<C>> void createJsonAssetAndInstall(JsonObject jsonObject, C customPack, Key namespacedKey, AssetType<C> assetType){
        try {
    ...
    public static <C extends CustomPack<C>> void installJsonFileAssetAndEdit(Asset<C> asset, C customPack, Key namespacedKey, AssetType<C> assetType, Consumer<JsonObject> editor) throws IOException {
